...
namespace Application.Features.TicketFeatures.Queries.GetTicketsList
{
    public class GetTicketsListQuery : IRequestHandler<GetTicketsListRequest, IEnumerable<GetTicketsListResponse>>
    {
        private readonly ITicketsRepository _ticketsRepository;
        private readonly IHttpContextAccessor _httpContextAccessor;


        public GetTicketsListQuery(ITicketsRepository ticketsRepository, IHttpContextAccessor httpContextAccessor)
        {
